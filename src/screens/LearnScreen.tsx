...
type ProfileScreenNavigationProp = NativeStackNavigationProp<LearnStackParamList>;
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => handleButtonPress('VocabTable')}
                    >
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => handleButtonPress('VerbConjugationTable')}
                    >
